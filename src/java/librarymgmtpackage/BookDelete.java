...
public class BookDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BookDelete</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BookDelete at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //String sql = "DELETE FROM dbo.Books WHERE Book_ID = '" + bookID + "', Book_Title = '" + bookTitle + "', Book_Author = '" + bookAuthor + "', Book_ISBN = '" + bookISBN + "', Book_No_Of_Copies = '" + bookNoOfCopies + "', Book_Published_Date = '" + bookPublishedDate + "', Book_Insert_Date = '" + bookInsertDate + "' WHERE Book_ID = '" + bookID + "'";
            String sql = "DELETE FROM dbo.Books WHERE Book_ID = '" + bookID + "'";
