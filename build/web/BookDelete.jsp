<%-- 
    Document   : BookDelete
    Created on : Dec 12, 2016, 11:11:21 AM
    Author     : Chulan
--%>
            ...
            <div class="row">
                ...
                <div class="col l4 offset-l4 m6 offset-m3 s12" style="padding: 50px 50px 50px 50px;border-radius: 5px;box-shadow: 1px 1px 20px whitesmoke"> 
                    <form action="BookDelete" method="POST">
                        ...
                        <div class="row center">
                            <button  class="waves-effect waves-light black white-text text-darken-1 btn center-align" type="submit">Delete</button>
                        </div>
                    </form>
                </div>
            </div>
